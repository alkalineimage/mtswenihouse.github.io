...
const	mhindexfooter	= document.getElementsByClassName("mhindexfooter")[0];
	...
	<div class="mhindexnav">	<div class="indexnav01">	</div>
	</div>
	`;
	// ------------------------------------------------------------------------------------------------
	// 02 BODY
	mhindexbody.innerHTML+=`	
	<div class="mhindexbody">	<div class="indexbody00">	
								<h1>${famtext.name01}</h1>
								<h1>${famtext.name02}</h1>
								<p>${famtext.name03}</p></div>

								<div class="indexbody01">	
								<a href="${page.roots00}">&#9679;</a>
								<a href="${page.bole00}">&#9679;</a></div>

								<div class="indexbody02">	
								<a href="${page.beams00}">&#9679;</a>
								<a href="${page.branches00}">&#9679;</a>
								<a href="${page.leaves00}">&#9679;</a></div>
	</div>
	`;
	// ----------------------------------------------------------------------------------------------
	// 03 FOOTER 
